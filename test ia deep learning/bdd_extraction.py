...
try:
    ...
    for info in resultat:
        if os.path.exists("dataset/"+info[1]+" "+info[2]):
            shutil.rmtree("dataset/"+info[1]+" "+info[2])
        os.mkdir("dataset/"+info[1]+" "+info[2])
        image1=info[5]
        image2=info[6]
        image3=info[7]
        image4=info[8]
        ...
        image6=info[10]
        image7=info[11]
        path1="dataset/"+info[1]+" "+info[2]+"/"+info[1]+" "+info[2]+"1"+".jpeg"
        path2="dataset/"+info[1]+" "+info[2]+"/"+info[1]+" "+info[2]+"2"+".jpeg"
        path3="dataset/"+info[1]+" "+info[2]+"/"+info[1]+" "+info[2]+"3"+".jpeg"
        path4="dataset/"+info[1]+" "+info[2]+"/"+info[1]+" "+info[2]+"4"+".jpeg"
        path5="dataset/"+info[1]+" "+info[2]+"/"+info[1]+" "+info[2]+"5"+".jpeg"
        path6="dataset/"+info[1]+" "+info[2]+"/"+info[1]+" "+info[2]+"6"+".jpeg"
        path7="dataset/"+info[1]+" "+info[2]+"/"+info[1]+" "+info[2]+"7"+".jpeg"
