...
while True:
    ...
    for encoding in encodings:
        ...
        if args["display"]>0:
            ...
            cursor.execute("UPDATE Etudiant SET Presence='$' WHERE Nom ='" + nom[0] +"'AND Prenom ='"+nom[1]+"'AND Presence='%'") #Permet de changer l'état de l'élève à absent si il est present et reconnu par l'IA #Mettre sur un autre pc
            conn.commit()
